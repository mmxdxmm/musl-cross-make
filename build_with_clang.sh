...
set_CC="ccache clang -Os -ffunction-sections -fdata-sections -Wno-error -Qunused-arguments -Wno-unknown-warning-option -stdlib=libc++"
set_LD="ld.lld --strip-debug --gc-sections -stdlib=libc++ -lc++ -lc++abi"
